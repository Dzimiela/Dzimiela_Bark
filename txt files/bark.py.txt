...
def loop():  # <1>
    ...
    options = OrderedDict({
        'A': Option('Add a bookmark', MYtest_commands.AddBookmarkCommand(), prep_call=get_new_bookmark_data),
        'B': Option('List bookmarks by date', MYtest_commands.ListBookmarksCommand()),
        'T': Option('List bookmarks by title', MYtest_commands.ListBookmarksCommand(order_by='title')),
        'D': Option('Delete a bookmark', MYtest_commands.DeleteBookmarkCommand(), prep_call=get_bookmark_id_for_deletion),
        'Q': Option('Quit', MYtest_commands.QuitCommand()),
    })
...
if __name__ == '__main__':
    MYtest_commands.CreateBookmarksTableCommand().execute()
...
def for_listings_only():
    options = {
        'A': Option('Add a bookmark', MYtest_commands.AddBookmarkCommand()),
        'B': Option('List bookmarks by date', MYtest_commands.ListBookmarksCommand()),
        'T': Option('List bookmarks by title', MYtest_commands.ListBookmarksCommand(order_by='title')),
        'D': Option('Delete a bookmark', MYtest_commands.DeleteBookmarkCommand()),
        'Q': Option('Quit', MYtest_commands.QuitCommand()),
    }
    print_options(options)